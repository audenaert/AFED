...
public class BasicFacsimile {
     ...
     *  the <code>DelegateFactory</code>, @see {@link org.idch.afed.legacy.isch.afed.DelegateFactory}.
     */
    ...
    public BasicFacsimile() {
        this.delegate = DelegateFactory.getFacsimileDelegate();
    }
    
    public BasicFacsimile(String name, String description, String date) {
        this.delegate = DelegateFactory.getFacsimileDelegate(name, description, date);
    }
    
    public BasicFacsimile(FacsimileDelegate delegate) {
